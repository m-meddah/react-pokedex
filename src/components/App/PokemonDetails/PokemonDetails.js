...
function PokemonDetails({ pokemons }) {
  ...
  const selectedPokemon = pokemons.find((pokemon) => pokemon.slug === slug);
  return (
            ...
            <div className="col-lg-8 fiche p-3">
              ...
              <div className="stats container-fluid.no-gutters mb-4">
                ...
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="status-bar rounded overflow-hidden"><span style={{ width: `calc((${selectedPokemon.stats.HP} / 255) * 100%)` }} />
                    </div>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="status-bar rounded overflow-hidden"><span
                      style={{ width: `calc((${selectedPokemon.stats.attack} / 255) * 100%)` }}
                    />
                    </div>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="status-bar rounded overflow-hidden"><span
                      style={{ width: `calc((${selectedPokemon.stats.defense} / 255) * 100%)` }}
                    />
                    </div>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="status-bar rounded overflow-hidden"><span
                      style={{ width: `calc((${selectedPokemon.stats.special_attack} / 255) * 100%)` }}
                    />
                    </div>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="status-bar rounded overflow-hidden"><span
                      style={{ width: `calc((${selectedPokemon.stats.special_defense} / 255) * 100%)` }}
                    />
                    </div>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="status-bar rounded overflow-hidden"><span
                      style={{ width: `calc((${selectedPokemon.stats.speed} / 255) * 100%)` }}
                    />
                    </div>
                  </div>
                </div>
